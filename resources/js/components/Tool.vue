<template>
  <div>
    ...
    <Card v-if="showTable" class="my-6 rounded-md mb-8">
      <nav
          class="overflow-x-auto overflow-y-hidden flex flex-col md:flex-row md:items-center md:justify-center pt-2 border-b border-gray-200 dark:border-gray-700">
